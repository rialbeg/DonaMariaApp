...
<head>
    ...
    <link rel="stylesheet" href="View/CSS/cadastrar_responsavel.css">
...
<body>
    ...
    <!-- <div class="container"> -->
    <form name="cadastrar_responsavel" class="container" action="alterarResponsavel" onsubmit="return validateForm()"
        ...
        <div class="inforesponsavel1">
            ...
            <input class="hidden" type="text" value="<?= $idResponsavel; ?>" name="idresponsavel">
